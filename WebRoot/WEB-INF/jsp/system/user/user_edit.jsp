...
<body class="no-skin">
						...
						<form action="user/${msg }.do" name="userForm" id="userForm_add"
							...
							<div id="zhongxin" style="padding-top: 20px;">
								<table id="table_report"
									...
									<c:if test="${fx != 'head'}">
										<tr>
											<td style="width:160px;text-align: right;padding-top: 13px;">角色:</td>
											<td id="juese"><select name="ROLE_ID" id="role_id1"
												data-placeholder="请选择角色" style="width:60%;height:25px">
													<option value=""></option>
									...
									<%-- <tr>
										<td style="width:160px;text-align: right;padding-top: 13px;">编号:</td>
										<td><input type="text" name="NUM" id="NUM"
											value="${pd.NUM }" maxlength="32" placeholder="这里输入编号"
									...
									<tr>
										<td style="width:160px;text-align: right;padding-top: 13px;">邮箱:</td>
									...
									<tr>
										...
										<td><input type="text" name="BZ" id="BZ"
											...
											title="备注" style="width:60%;" /></td>
									</tr>
									<tr>
										<td style="width:160px;text-align: right;padding-top: 13px;">管理录音宝账户:</td>
										<td><a class="btn btn-mini btn-primary"
											onclick="choiceDevuser();">选择</a>
											<input  type="hidden" readonly style="border:0px red solid" id="DEVUSERS" name="DEVUSERS" value="${pd.DEVUSERS }">
											<span id="userstr">${pd.DEVUSERS} </span>
										</td>
									</tr>
									<tr>
	...
	//保存
	function choiceDevuser(){
		 var winId = "choiceuserWin";
		 modals.openWin({
	          winId: winId,
	          title: '选择录音宝账户',
	          width: '800px',
	          url: '<%=basePath%>appUploadFile/devuser_list.do'
	      });
	}
	function save(){
		//alert($("#role_id1").val());
