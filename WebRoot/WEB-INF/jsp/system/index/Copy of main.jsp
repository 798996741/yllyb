...
<body class="hold-transition skin-blue sidebar-mini"
	...
	<div class="wrapper">
		...
		<div class="content-wrapper" style="position: relative;">
			...
			<!-- Main content -->
			<section class="content container-fluid" style="margin:0px;padding-top:0px;padding-left:10px;position:absolute;top:0px;left:0px;right:0px;bottom:0px;background:#ffffff;">
				<iframe name="mainFrame" id="mainFrame" frameborder="0" src="tab.do"
					style="margin:0 auto;padding:0px;width:100%;height:100%;display:block;background:#ffffff;"></iframe>
			</section>
			<!-- /.content -->
		</div>
		<!-- /.content-wrapper -->
