...
<div class="bg">
        ...
        <main class="page-main">
           <form class="page-form" id="Form_add">
				...
				<div class="form-item gray__border">
				    <label class="form-label">住&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址</label>
				    <div class="form-content">
				        <div class="form-input">
				...
				<div class="form-item">
					<div class="form-item-half">
						<label class="form-label" style="width: 3.5rem">毕业时间</label>
					...
					<input type="hidden" id="BYDATE" name="BYDATE" >
					<div class="form-item-half">
						<label class="form-label" style="width: 3.5rem">毕业院校</label>
						<div class="form-content form-date">
							<div id='showschoolPicker'>请选择院校
								<div class="down-icon"></div>
							</div>
						</div>
					</div>
					<input type="hidden" id="BYYX" name="BYYX" >
				</div>
                <div class="form-item gray__border">
				 ...
				 <div class="form-item gray__border">
				    <label class="form-label">创业意向</label>
				    <div class="form-content">
						<div class="form-content-right">
							<input type="radio" name="BUSINESS" id="BUSINESS" value="1" checked /> 是
							<input type="radio" name="BUSINESS" id="BUSINESS" value="0" /> 否
						</div>
					</div>
				</div>
                <div class="form-item">
...
(function ($) {
        ...
        btn.addEventListener('tap', function () {
            ...
            if (_self.picker) {
                _self.picker.show(function (rs) {
                    ...
                    _self.picker = null;
                    document.getElementById("BYDATE").value=rs.text;
    ...
    moneyPicker.setData(${byyxjson});
    var showschoolPickerButton = document.getElementById('showschoolPicker');
    showschoolPickerButton.addEventListener('tap', function (event) {
    	moneyPicker.show(function (items) {
    		console.log(items[0])
    		showschoolPickerButton.innerText = _getParam(items[0], 'text');
    		//返回 false 可以阻止选择框的关闭
    		//return false;
    		document.getElementById("BYYX").value=items[0].value;
    	});
    }, false);
