							...
							<ul>
								<li class="detail-material__item">
									...
									<div class="detail-material__content">
										<div class="material-content__item color-blue gray__border">
											| 材料模板
											<a href="appweixin/template?action=rdsqb" class="detail-material__look"><img src="static/weixin/images/look.png" /></a>
										</div>
										<div class="material-content__item color-blue gray__border">
											| 材料来源
								...
								<li class="detail-material__item">
									...
									<div class="detail-material__content">
										<div class="material-content__item color-blue gray__border">
											| 材料模板
											<a href="appweixin/template?action=rddj" class="detail-material__look"><img src="static/weixin/images/look.png" /></a>
										</div>
										<div class="material-content__item color-blue gray__border">
											| 材料来源
											<a href="appweixin/template?action=sydjz" class="detail-material__todo"><img src="static/weixin/images/todo.png" /></a>
										</div>
										<div class="detail-material__detail">
								...
								<li class="detail-material__item">
									...
									<div class="detail-material__content">
										<div class="material-content__item color-blue gray__border">
											| 材料模板
											<a href="appweixin/template?action=sydjb" class="detail-material__look"><img src="static/weixin/images/look.png" /></a>
										</div>
										<div class="material-content__item color-blue gray__border">
											| 材料来源
											<div class="detail-material__todo"></div>
