								...
								<li class="detail-material__item">
									...
									<div class="detail-material__content">
										<div class="material-content__item color-blue gray__border">
											| 材料模板
											<a href="appweixin/template?action=sydjb" class="detail-material__look">
<img src="static/weixin/images/look.png" />
								...
								<li class="detail-material__item">
									...
									<div class="detail-material__content">
										<div class="material-content__item color-blue gray__border">
											| 材料模板
											<a href="appweixin/template?action=hkp" class="detail-material__look"><img src="static/weixin/images/look.png" /></a>
										</div>
										<div class="material-content__item color-blue gray__border">
											| 材料来源
											<div class="detail-material__todo"></div>
								...
								<li class="detail-material__item">
									...
									<div class="detail-material__content">
										<div class="material-content__item color-blue gray__border">
											| 材料模板
											<a href="appweixin/template?action=sfz" class="detail-material__look"><img src="static/weixin/images/look.png" /></a>
										</div>
										<div class="material-content__item color-blue gray__border">
											| 材料来源
											<div class="detail-material__todo"></div>
