...
public class Page {
	...
	public String getPageStr() throws UnsupportedEncodingException {
		...
		if(totalResult>0){
			...
			if(currentPage==1){
//				sb.append("	<li><a>total<font color=red>"+totalResult+"</font>item</a></li>\n");
//				sb.append("	<li><input type=\"number\" value=\"\" id=\"toGoPage\" style=\"width:50px;text-align:center;float:left\" placeholder=\"page number\"/></li>\n");
//				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"toTZ();\"  class=\"btn btn-mini btn-success\">跳转</a></li>\n");
				sb.append("	<li><a>home page</a></li>\n");
				sb.append("	<li><a>page up</a></li>\n");
			}else{
//				sb.append("	<li><a>total<font color=red>"+totalResult+"</font>item</a></li>\n");
//				sb.append("	<li><input type=\"number\" value=\"\" id=\"toGoPage\" style=\"width:50px;text-align:center;float:left\" placeholder=\"page number\"/></li>\n");
//				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"toTZ();\"  class=\"btn btn-mini btn-success\">跳转</a></li>\n");
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"nextPage(1)\">home page</a></li>\n");
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"nextPage("+(currentPage-1)+")\">page up</a></li>\n");
			}
			...
			if(currentPage==totalPage){
				sb.append("	<li><a>next page</a></li>\n");
				sb.append("	<li><a>end page</a></li>\n");
			}else{
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"nextPage("+(currentPage+1)+")\">next page</a></li>\n");
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"nextPage("+totalPage+")\">end page</a></li>\n");
			}
//			sb.append("	<li><a>total "+totalPage+" item</a></li>\n");
			sb.append("	<li><select title='total' style=\"width:55px;float:left;margin-top:1px;\" onchange=\"changeCount(this.value)\">\n");
