						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							<thead>
								<tr>
									...
									<th class="center">该状态持续时间</th>
									<th class="center"><i class="ace-icon fa fa-envelope-o"></i>当日累计接线数量</th>
								</tr>
							</thead>
							...
							<!-- 开始循环 -->	
							<c:choose>
								<c:when test="${not empty listtj}">
									<c:forEach items="${listtj}" var="tagentState" varStatus="vs">
										
										<tr>
											
											<td class='center' style="width: 30px;">${vs.index+1}</td>
											<td class="center">${tagentState.AGENTEID }</td>
											<td class="center" style="color:red">
												${tagentState.AGENTNAME }
											</td>
											<td class="center">${tagentState.STATE }</td>
											<td class="center">${tagentState.UTIME }</td>
											<td class="center">${tagentState.JTL }</td>
