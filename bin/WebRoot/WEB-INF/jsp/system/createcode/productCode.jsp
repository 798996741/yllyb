...
<div class="main-container" id="main-container">
	...
	<div class="main-content">
					...
					<form action="createCode/proCode.do" name="Form_add" id="Form_add" method="post">
						...
						<table style="margin-top: 5px;">
							<tr>
								...
								<td>&nbsp;&nbsp;例如:com.lzzj.controller.<font color="red" style="font-weight: bold;">system</font>&nbsp;&nbsp;只输入红色部分</td>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="text-align: center;" colspan="100">
									...
									<a class="btn btn-app btn-danger btn-xs"  data-btn-type="cancel" data-dismiss="modal"><i class="ace-icon fa fa-reply icon-only"></i>取消</a>
								</td>
							</tr>
						</table>
						</div>
