										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<c:if test="${QX.del == 1 }">
														<a class="btn btn-xs btn-danger" style="margin-left:10px;" onclick="delUser('${endpoint.id }','${endpoint.username }');">
		...
		function set(id){
			...
			var winId = "userWin";
			  modals.openWin({
		        ...
		        width: '900px',
		        height:'400px',
		        url: '<%=basePath%>endpoint/toendpointSet.do?action=2&ID='+id
