		...
		<main class="page-main">
			<div class="site-nav-wrapper">
				<div class="site-nav nav-person">
					...
					<div class="nav-describe">实时获取适用于个人的就业、生活等政策补贴福利</div>
				</div>
				<div class="site-nav nav-company">
					...
					<div class="nav-describe">实时获取适用于企业的创业、融资等扶持政策福利</div>
				</div>
			</div>
		</main>
		<footer>
			<div class="footer-title">人社宝为您提供最适合您、最全面的政策咨讯政策申报最多跑一趟</div>
		</footer>
	</div>
</body>
</html>