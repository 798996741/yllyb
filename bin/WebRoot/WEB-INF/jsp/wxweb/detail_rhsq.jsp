...
function search(action){
	location.href="appweixin/template?action=rhsq";
}
  </script>
</head>
<body>
			...
			<div class="detail-cont">
				<div class="detail-block">
					<div class="detail-title color-green gray__border">
						● 就业困难人员社保补贴如何申请
						<a href="appweixin/template?action=sbbtsq" class="common-question">
							...
							<ul class="detail-material__wrapper">
								...
								<li class="detail-material__item">
									...
									<div class="detail-material__content">
										<div class="material-content__item color-blue gray__border">
											| 材料模板
											<a href="appweixin/template?action=sydjz" class="detail-material__look"></a>
										</div>
										<div class="material-content__item color-blue gray__border">
											| 材料来源
											<a href="appweixin/template?action=djz" class="detail-material__todo"></a>
										</div>
										<div class="detail-material__detail">
