package com.shpro.service.${packageName}.impl;
...
import com.shpro.service.${packageName}.${objectName}Manager;
...
public class ${objectName}Service implements ${objectName}Manager{
	...
	public List<PageData> list(Page page)throws Exception{
		return (List<PageData>)dao.findForList("${objectName}Mapper.datalist", page);
	}
